...
import { ConteoDiferenciasService } from '../conteo-diferencias/conteo-diferencias.service';
...
@Component({
  selector: 'app-conteo-diferencias-sap',
  standalone: true,
  imports: [FormsModule, BannerCabeceraComponent, CommonModule],
  templateUrl: './conteo-diferencias-sap.component.html',
  styleUrl: './conteo-diferencias-sap.component.css'
})
export class ConteoDiferenciasSapComponent {
  ...
  consultarConteosAsignados(): void {
    ...
    this.conteoDifService.obtenerConteosDiferenciasSap(this.bodegaSeleccionada, idUsuario).subscribe(
      (respuesta) => {
