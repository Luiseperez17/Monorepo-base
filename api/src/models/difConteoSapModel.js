...
const app_dif_sap_conteo = sequelize.define(
    "app_dif_sap_conteo", 
    {
        id: {
        ...
        costo_articulo: {
          ...
          allowNull: true,
          defaultValue: null,
          comment: "Costo del artículo",
        },
        costo_diferencia: {
          type: DataTypes.DOUBLE,
          allowNull: true,
          defaultValue: null,
          comment: "Costo Diferencia",
        },
        cantidad_correccion: {
          type: DataTypes.INTEGER,
          allowNull: false,
        ...
        tableName: "app_dif_sap_conteo",
        timestamps: true, // Habilita createdAt y updatedAt
    }
);


module.exports = app_dif_sap_conteo;
